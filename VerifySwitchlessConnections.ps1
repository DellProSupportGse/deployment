...
$GetNetAdapterAdvancedProperty=Get-ChildItem -Path $SDDCPath -Filter GetNetAdapterAdvancedProperty.xml -Recurse -Depth 2 | Import-Clixml | Where-Object{($_.InterfaceDescription -imatch "QLogic") -or ($_.InterfaceDescription -imatch "Mellanox")-or ($_.InterfaceDescription -imatch "E810")} 
