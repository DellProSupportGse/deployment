...
# RDMA QOS setting for Mellanox
    If((Get-NetAdapter $S1Nic,$S2Nic | Select InterfaceDescription) -imatch 'Mellanox|NVIDIA' -or ((Get-PhysicalDisk | Where-Object{$_.MediaType -inotmatch 'HDD'}).count -eq 0)){
